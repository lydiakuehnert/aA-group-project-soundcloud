...
def seed_users():
    demo = User(
        username='Demo', email='demo@aa.io', password='password', firstname='John', lastname='Smith', image='https://upload.wikimedia.org/wikipedia/commons/8/8f/Human_eye_with_blood_vessels.jpg')
    marnie = User(
